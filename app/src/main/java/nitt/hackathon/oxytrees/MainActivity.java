...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       */
        ...
        PrimaryDrawerItem i7 =new PrimaryDrawerItem().withIdentifier(6).withName("LeaderBoard").withIcon(getResources().getDrawable(R.drawable.ld));
        PrimaryDrawerItem i8 =new PrimaryDrawerItem().withIdentifier(7).withName("About Us").withIcon(getResources().getDrawable(R.drawable.about));
